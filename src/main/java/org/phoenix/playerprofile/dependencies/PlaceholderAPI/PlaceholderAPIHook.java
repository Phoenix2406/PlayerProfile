...
public class PlaceholderAPIHook {
    ...
    public PlaceholderAPIHook(ProfileCore plugin) {
        if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null) {
            Logger.log(Logger.LogLevel.SUCCESS, "Hook into PlaceholderAPI.");
            new PlaceholderAPIExpansion(plugin).register();
        } else {
            throw new UnknownDependencyException("Couldn't find PlaceholderAPI Plugin! This plugin is required for player profile placeholder.");
        }
    }
}
