...
public class CommandVersion {
    ...
    public CommandVersion(ProfileCore plugin) {
        this.plugin = plugin;
    }
     ...
     */
    @JDACommand(name = "version", description = "See version of the plugin via discord.", adminPerms = "Permission.Admin", onlyAdmin = true)
    public void onVersionCommandUsed(SlashCommandInteractionEvent event) {
        ...
        if (DiscordCore.getDiscordCore().getGuild().getVoiceChannelById(ProfileCore.getDiscordConfig().getInstance().getString("ChannelId")) == null) {
            if (DiscordCore.getDiscordCore().getGuild().getTextChannelById(ProfileCore.getDiscordConfig().getInstance().getString("ChannelId")) == null) {
                CommandConstruction.VersionCommand(plugin, event);
            } else {
